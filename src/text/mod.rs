...
use skia_safe as sk;
use skia_safe::{textlayout::FontCollection, FontMgr, FontStyle};
...
impl TextStyle {
    ...
    pub fn font_weight(mut self, font_weight: i32) -> TextStyle {
    ...
    pub fn compare_to(&self, other: &TextStyle) -> ChangeKind {
        if self.font_size != other.font_size || self.font_families != other.font_families || self.font_weight != other.font_weight {
    ...
    pub fn to_skia(&self) -> sk::textlayout::TextStyle {
        ...
        if let Some(font_weight) = self.font_weight {
            sk_style.set_font_style(FontStyle::new(Weight::from(font_weight), sk::font_style::Width::NORMAL, sk::font_style::Slant::Upright));
        }
        sk_style
    }
}
